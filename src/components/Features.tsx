      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="bg-white p-6 rounded-xl border border-gray-100 hover:border-food-cream hover:shadow-lg transition-all duration-300 group"
            >
              <div className="bg-gradient-to-r from-food-orange to-food-orange-dark text-white p-3 rounded-lg inline-block mb-4 group-hover:shadow-lg transition-shadow">
                {feature.icon}
              </div>
        ...
        {/* Stats Section */}
        <div className="mt-20 bg-gradient-to-r from-food-orange to-food-orange-dark rounded-2xl p-8 text-white">
